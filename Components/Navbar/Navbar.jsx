...
function Navbar() {
  return (
    <>
      <nav className="navbar navbar-expand-lg d-flex justify-content-evenly navbar-light bg-light">
  <div className="container-fluid d-flex justify-content-evenly">
    <a className="navbar-brand  badge bg-secondary" href="#">Navbar</a>
    ...
    <ul className="d-flex about">
     ...
     <li><a className="nav-item" href="https://wa.me/" target="_blank"><FaWhatsapp size={20} /></a></li>   
    </ul>   
    </div>
  </div>
</nav>
